...
const envSchema = zod_1.z.object({
    ...
    FEDAPAY_PUBLIC_KEY: zod_1.z.string().min(1),
    FEDAPAY_SECRET_KEY: zod_1.z.string().min(20, 'Clé FedaPay trop courte — vérifiez sur app.fedapay.com'),
    FEDAPAY_BASE_URL: zod_1.z.string().default('https://sandbox-api.fedapay.com'),
