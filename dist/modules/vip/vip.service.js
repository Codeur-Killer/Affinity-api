...
exports.getVipDashboard = getVipDashboard;
const prisma_1 = require("../../config/prisma");
async function getVipDashboard(userId) {
    ...
    const [referrals, referralsThisMonth] = await Promise.all([
        prisma_1.prisma.vipReferral.findMany({
        ...
        prisma_1.prisma.vipReferral.count({
    ...
    const subscribers = await prisma_1.prisma.profile.findMany({
